...
# 用after获取10:16之后的数据(包含10:16)
ts_1017 = 1773541020000  # 10:17

doge = client.get_history_kline('DOGE-USDT', bar='1m', limit=300, after=str(ts_1017))
eth = client.get_history_kline('ETH-USDT', bar='1m', limit=300, after=str(ts_1017))
